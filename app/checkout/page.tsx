            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
                  ...
                  <div key={step} className="flex items-center">
                    ...
                    <div className="ml-2">
                      <div className={`text-sm font-medium ${
                        activeStep === step ? 'text-rose-600' : activeStep > step ? 'text-green-600' : 'text-gray-500'
                      }`}>
              ...
              {activeStep === 1 && (
                <div>
                  ...
                  <div className="mb-6">
                    <label htmlFor="deliveryInstructions" className="block text-sm font-medium text-gray-700 mb-1">Delivery Instructions (Optional)</label>
                    <textarea
                ...
                <div>
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6">
                    <div className="flex items-start">
                      ...
                      <div className="ml-3">
                        <h3 className="text-sm font-medium text-blue-800">Cash Payment</h3>
                ...
                {cart.map((item) => {
                  ...
                  return (
                    <div key={item.id} className="flex justify-between">
                      <div>
                        <div className="font-medium text-gray-900">{menuItem.name} <span className="text-gray-500">x{item.quantity}</span></div>
                        <div className="text-sm text-gray-500">{menuItem.description}</div>
                      </div>
                      <div className="font-medium">${(menuItem.price * item.quantity).toFixed(2)}</div>
                    </div>
                  );
                })}
